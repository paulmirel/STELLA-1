...
Modified by Paul Mirel for NASA
"""
...
if True:
    ...
    print(
        f"F1-405:{readings[Channel.F1]}",
        f"  F2-425:{readings[Channel.F2]}",
        f"  FZ-450:{readings[Channel.FZ]}",
        f"  F3-475:{readings[Channel.F3]}",
        f"  F4-515:{readings[Channel.F4]}",
        f"  F5-550:{readings[Channel.F5]}",
        f"  FY-555:{readings[Channel.FY]}",
        f"  FXL-600:{readings[Channel.FXL]}",
        f"  F6-640:{readings[Channel.F6]}",
        f"  F7-690:{readings[Channel.F7]}",
        f"  F8-745:{readings[Channel.F8]}",
        f"  NIR-855:{readings[Channel.NIR]}")
