 ...
 * @return true: success false: failure
    ...
    @property
    def read_channel_register(self) -> Tuple[int, ...]:
        """The four values in the register. config_f1_f4 or config_f5-f8 prior to this to choose which four values you'll get """
        adc_reads = self._all_channels
        reads = adc_reads[1:5]
        return reads
