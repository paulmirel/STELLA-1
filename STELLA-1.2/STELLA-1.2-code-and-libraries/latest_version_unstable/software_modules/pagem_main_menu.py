...
class Main_Menu_Page( Page ):
    ...
    def make_group( self ):
        menu_list = "Remote Sense", "Set Exposure", "Air Analyzer", "Time / Place", "Sensors", "*future use", "*future use", "*future use"#, "* Air Analyz", "* Heat", "* Plants"
        menu_color_list = 20, 5, 12, 14, 21, 19, 19, 19, 19
